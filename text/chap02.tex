...
or feignedly; doleful; woeful; pitiable; as, "a whining tone and a lugubrious look".
...
\mynote{skite}{(n.): \textdbend =skete(?), a kind of hermitage;
...
%}
\mynote{unction}{(n.): OED 3c., transf. A manner of utterance or address 
showing real appreciation or enjoyment of the subject or situation.
The original meaning is the action of anointing with oil as a religious 
rite or symbol.
}
of religious conventionality was featureless.

Darconville's cat leaped onto the windowsill and peered 
  \mynote{peer}{(v.): OED 1, to look narrowly, esp. in order to discern 
  something indistinct or difficult to make out. 
  }
up, as if collating
  %\mynote{collate}{(v.): to assemble in proper sequence}
  \mynote{collate}{(v.): OED 2, To bring together for comparison; to compare 
  carefully and exactly, in order to ascertain points of agreement and difference.
  }
...
neither fascination nor fatigue, sought only to stem 
  \mynote{stem}{(v.): OED 2-2, trans. To stop, check; to dam up (a stream, or
  the like).
  }
...
with several rapturous 
  \mynote{rapturous}{(adj.): Ecstatic; transporting; ravishing; feeling, 
  expressing, or manifesting rapture; as, “rapturous joy, pleasure, or 
  delight; rapturous applause.”
  }
edificial 
  \mynote{edificial}{(a.): Of or pertaining to building, architectural.}
